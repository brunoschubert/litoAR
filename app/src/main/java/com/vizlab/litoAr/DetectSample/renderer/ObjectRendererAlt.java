...
public class ObjectRendererAlt {
    ...
    public ObjectRendererAlt(String objPath) {
        OBJ_PATH = objPath;
    }

    public ObjectRendererAlt() {}
    ...
    public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
        ...
        ShaderLoader.checkGLError(TAG, "Texture loading");
        ...
        ShaderLoader.checkGLError(TAG, "OBJ buffer load");

        final int vertexShader =
                ShaderLoader.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, "shaders/object_vertex.vert");
        final int fragmentShader =
                ShaderLoader.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, "shaders/object_fragment.frag");
    ...
    public void createOnGlThread(Context context
        ...
        if (obj.getNumMaterialGroups() == 0 && obj.getMtlFileNames().size() == 0) {
        ...
        vectorArrayObjectIds = new int[obj.getNumMaterialGroups()];
        GLES30.glGenVertexArrays(obj.getNumMaterialGroups(), vectorArrayObjectIds, 0);

        FloatBuffer vertices = ObjData.getVertices(obj);
        FloatBuffer texCoords = ObjData.getTexCoords(obj, 2);
        FloatBuffer normals = ObjData.getNormals(obj);
        textures = new int[obj.getNumMaterialGroups()];
        GLES20.glGenTextures(textures.length, textures, 0);
        ...
        for (int i = 0; i < obj.getNumMaterialGroups(); i++) {
            ...
            ObjGroup currentMatGroup = obj.getMaterialGroup(i);
            ...
            if (!obj.getMtlFileNames().isEmpty()) {
                List<Mtl> mtlList = MtlReader.read(
                        context.getAssets().open(parentDirectory + obj.getMtlFileNames().get(0)));
                Mtl targetMat = null;
                for (Mtl mat : mtlList) {
            ...
            //Compile shaders
            //TODO: get shaders.
            final int vertexShader = ShaderLoader.loadGLShader(TAG, context,
                    GLES20.GL_VERTEX_SHADER, "shaders/object_vertex.vert");
            final int fragmentShader = ShaderLoader.loadGLShader(TAG, context,
                    GLES20.GL_FRAGMENT_SHADER, "shaders/object_fragment.frag");
     ...
     */
    public void updateModelMatrixAndy(float[] modelMatrix, float scaleFactor) {
    ...
    public void draw(
        ...
        ShaderLoader.checkGLError(TAG, "Before draw");
        ...
        ShaderLoader.checkGLError(TAG, "After draw");
    }
    ...
    public void draw(float[] cameraView, float[] cameraPerspective, float lightIntensity) {
        ...
        if (blendMode != null) {
            ...
            switch (blendMode) {
                case Shadow:
                    ...
                    GLES20.glBlendFunc(GLES20.GL_ZERO, GLES20.GL_ONE_MINUS_SRC_ALPHA);
                    break;
                    //TODO: Is this actual Source Alpha or Grid?
                case Grid:
        ...
        for (int i = 0; i < obj.getNumMaterialGroups(); i++) {
            ...
            GLES20.glDrawElements(GLES20.GL_TRIANGLES, obj.getMaterialGroup(i).getNumFaces() * 3,
